              ...
              >
                ...
                {loadingHistory ? (
                  ...
                  <Card className="text-center py-16">
                    <div className="inline-flex items-center justify-center w-24 h-24 bg-orange/10 rounded-full mb-6 animate-fadeIn">
                      <Icon
                    ...
                    <p className="font-body text-text-secondary max-w-md mx-auto">
                      Your financial history will appear here once you save your first entry.
                    </p>
                  </Card>
                ) : (
